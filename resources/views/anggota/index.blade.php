...
<span class="glyphicon glyphicon-plus"></span> Tambah Anggota</a>
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        route('anggota.show',$value->id) }}">Lihat</a>
        <a class="btn btn-primary" href="{{
        route('anggota.edit',$value->id) }}">Ubah</a>
        {!! Form::open(['method' => 'DELETE','route' =>
        ['anggota.destroy', $value->id],
