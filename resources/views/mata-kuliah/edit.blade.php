@extends('layouts.app')
@section('content')
<h4>Mengubah Mata Kuliah Baru</h4>
<form action="{{ route('mata-kuliahs.update',$mataKuliah->id) }}" method="post">
    {{csrf_field()}}
    {{ method_field('PUT') }}
    @if (count($errors) > 0)
        <div class="alert alert-danger">Terdapat beberapa kasalahan pada saat mengisi yang harus diperbiki.<br><br>
            <ul>
